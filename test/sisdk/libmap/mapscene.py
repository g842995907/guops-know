...
from sisdk.libmap.enums import EnumModelType, EnumStatus, EnumLineType, EnumEdgeStatus, EnumOnoff
from sisdk.libmap.map_behavior_pb2 import net_entity, edge, model_pos, dest_object
