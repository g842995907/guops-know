...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        onLoadSuccess: function (data) {
            let _this = this
            if(this.element){
                $(".pull-right .pagination").after("<div class='pageBox'>" +
            ...
            $(".pageBtn").click(function () {
                let goPage = parseInt($(".pageNum").val());
                $(_this.element).bootstrapTable('selectPage', goPage);
            });
            return false;
        },
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES.en = {
        ...
        formatNoMatches: function () {
            return gettext("x_no_match_found");
        },
