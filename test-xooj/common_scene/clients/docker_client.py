...
if __name__ == "__main__":
    ...
    nets = cli.list_networks(names='4ace078a-9843-4085-815f-85fa992a03d6')
    aa = cli.prune_networks(filters={'name': '4ace078a-9843-4085-815f-85fa992a03d6'})
    res_list = []
    local_containers = cli.list_containers()
    ...
    print res_list
    try:
        img = cli.inspect_image("cc_ret2text")
    except Exception, e:
        pass

    img_obj = cli.import_image_from_file("/home/moose/Downloads/alpine.tar", "alpine")
    print img_obj
