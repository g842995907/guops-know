...
if __name__ == "__main__":
    ...
    inst = cli.instance_get_all()[0]
    bbb = cli.check_first_boot("280d3744-4826-49ee-aeae-85fe296b397a")
    hps = cli.hypervisor_stats()
    ...
    inst = cli.instance_get_by_id("280d3744-4826-49ee-aeae-85fe296b397a")
