...
from sisdk.libcr.proto3.cr_sandtable_pb2 import (sandtable_attack, sandtable_settings, sandtable_entity,
                                                 sandtable_effects, sandtable_panel, sandtable_arbiter_show_hide, sandtable_guide_line)
from sisdk.libcr.proto3.base_pb2 import camera_settings
...
class AtomSandTable(object):
    ...
    @staticmethod
    def mk_sandtable_attack(intensity=EnumAttackIntensity.attack_extreme,
                            attack_speed=0,
                            src_obj_id="",
                            dest_obj_id="",
                            color="",
