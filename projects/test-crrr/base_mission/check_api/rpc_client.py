...
class ScriptClient(RpcThrift):
    ...
    def py_script_check(self, **kwargs):
        ...
        self.logger.debug("[python-mission] Checker ip :[%s], Checker port :[%d]",
                          self.content.get("checker_ip"), self.content.get("checker_port"))
        self.logger.debug("[python-mission] Parameter: [%s]", parameter)
    ...
    def sh_script_check(self, **kwargs):
        ...
        self.logger.debug("[shell mission] Checker ip :[%s], Checker port :[%d], Parameter: [%s]",
    ...
    def agent_python_check(self, **kwargs):
        ...
        self.logger.info("[python-mission] Checker ip :[%s], Checker port :[%d]",
                         self.content.get("checker_ip"), self.content.get("checker_port"))
        self.logger.info("[python-mission] Parameter: [%s]", parameter)
    ...
    def agent_shell_check(self, **kwargs):
        ...
        self.logger.info("[shell mission] Checker ip :[%s], Checker port :[%d]",
                         self.content.get("checker_ip"), self.content.get("checker_port"))
        self.logger.info("[shell mission] Parameter: [%s]", parameter_str)
