# -*- coding: utf-8 -*-
# 运行: python compile.py build_ext --build-lib build/x-oj
# cython打包注意
...
setup(
    ...
    ext_modules=cythonize(ext_modules, build_dir='build/x-oj-build')
)
