...
class PackagedMessages2(object):
    ...
    def topo_attack(src_obj, dest_obj, success=True, show_guildline=True,
        ...
        smq = SequenceMessageMaker2(Enums.EnumMessageType.behavior, Enums.EnumScenarioType.topology)
        if show_guildline:
    ...
    def sandtable_attack(src_obj, dest_obj, success=True, show_guildline=True, icon=Enums.EnumEffectIcon.information,
        ...
        m_panel = AtomSandTable.mk_sandtable_panel(src_obj_id=dest_obj, icon=icon,
                                     ...
                                     wrap=False)
        smq = SequenceMessageMaker2(Enums.EnumMessageType.behavior, Enums.EnumScenarioType.sandtable)
        if show_guildline:
