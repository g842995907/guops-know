...
from practice_exercise.response import CONSTANTTYPE
from practice_exercise.utils.utils import handle_markdown
...
class PracticeExerciseTaskSerializer(BaseEnvTaskSerializer):
    TASK_TYPE = PRACTICE_TYPE_EXCRISE
...
class PracticeExerciseTaskSerializerForEdit(EnvTaskSerializerForEditMixin, PracticeExerciseTaskSerializer):
    pass
