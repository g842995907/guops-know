...
from cr_scene.utils.scene_util import get_cr_scene_by_id
...
class SceneTrafficManager(object):
    ...
    def __init__(self, scene_id, cr_scene_id=None, cr_event_id=None):
        self.scene_id = scene_id
        self.cr_scene = get_cr_scene_by_id(cr_scene_id, cr_event_id)
