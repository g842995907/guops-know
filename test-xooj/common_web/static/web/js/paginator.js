(function ($) {
    ...
    BootstrapPaginator.prototype = {
        ...
        setOptions: function (options) {
            ...
            if (options && typeof (options.callback) !== 'undefined' && (options.totalPages)) {
                if (this.options.flag === true || this.options.flag === undefined){
        ...
        loadSuccess: function () {
            if(this.options.flag){
                ...
                "<input type='button' value='GO' class='pageBtn' onclick=''></div>")
                $(".paginationBox").on("click",".pageBtn",function () {
                    _this.clickBtn()
                })
        ...
        clickBtn: function () {
            ...
            if(!goPage || this.totalPages < goPage){
                return
            }
            let limit = pageSize;
            let offset = (goPage-1)*limit
            this.options.callback(offset, limit);
            $(".pageNum").val('')
        }
