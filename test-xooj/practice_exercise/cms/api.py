...
from practice_exercise.response import TaskResError
from . import serializers as mserializers


class PracticeExerciseTaskViewSet(
    ...
    queryset = exercise_models.PracticeExerciseTask.objects.all()
    serializer_class = mserializers.PracticeExerciseTaskSerializer
    ...
    def sub_perform_create(self, serializer):
        ...
        if exercise_models.PracticeExerciseTask.objects.filter(title=serializer.validated_data['title'],
...
class PracticeExerciseCategoryViewSet(CacheModelMixin, DestroyModelMixin,
                                      viewsets.ModelViewSet):
    queryset = exercise_models.PracticeExerciseCategory.objects.all()
    serializer_class = mserializers.PracticeExerciseCategorySerializer
    permission_classes = (IsAuthenticated, IsStaffPermission,)
    ...
    def perform_batch_destroy(self, queryset):
        ...
        has_normal_choiceTask = exercise_models.PracticeExerciseTask.original_objects.filter(category__in=ids,
                                                                                             is_copy=False,
    ...
    def sub_perform_create(self, serializer):
        if exercise_models.PracticeExerciseCategory.objects.filter(
