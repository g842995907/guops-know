...
_ENUM_PANEL_TYPE = _descriptor.EnumDescriptor(
  ...
  full_name='cr_enum2.enum_panel_type',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_ENUM_EFFECT_ICON = _descriptor.EnumDescriptor(
  ...
  full_name='cr_enum2.enum_effect_icon',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_ENUM_ATTACK_INTENSITY = _descriptor.EnumDescriptor(
  ...
  full_name='cr_enum2.enum_attack_intensity',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
