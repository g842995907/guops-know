...
class Client(object):
    def __init__(self, **kwargs):
        self.cli = DockerHTTPClient(
            base_url=kwargs.get("base_url") or app_settings.COMPLEX_MISC.get("base_url"),
            ca_cert=app_settings.COMPLEX_MISC.get("ca_cert") or DEFAULT_CA_PATH,
            client_key=app_settings.COMPLEX_MISC.get("client_key") or DEFAULT_CLIENT_KEY_PATH,
            client_cert=app_settings.COMPLEX_MISC.get("client_cert") or DEFAULT_CLIENT_CERT_PATH)
